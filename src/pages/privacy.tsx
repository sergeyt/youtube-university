  ...
  return (
    <>
      ...
      <main>
        ...
        <p>Last updated: September 26, 2021</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to YouTube University.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to YouTube University, accessible
              from{" "}
              <a
                href="https://youtube-university.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://youtube-university.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: stodyshev@gmail.com</li>
        </ul>
      </main>
    </>
  );
